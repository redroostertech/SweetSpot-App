    ...
    override func viewDidLoad() {
        ...
        for label in lbl_AdditionalDetails {
            ...
            if label.text == "Tannin" && wine.getAlcoholstrength() != ""{
                ...
                label.text = "Alcohol: " + wine.getAlcoholstrength()
            }
            else if label.text == "Alcohol" && wine.getBottlesizeml() > 0 {
                label.text = "Bottle Size (mL): \(wine.getBottlesizeml())"
            }
        ...
        SSAnalytics.reportUserAction(action_type: SSAnalytics.AnalyticsActionType.VIEW_WINE_DETAILS)
    }
