    ...
    UITableViewDataSource
{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        SSAnalytics.reportUserAction(action_type: SSAnalytics.AnalyticsActionType.FIND_MY_WINE_RETAIL_LIST)
        ...
        Alamofire.request(AppConstants.RM_SERVER_URL, parameters: parameters, encoding: URLEncoding.default).responseString { response in
            ...
            case 2:
                ...
                if(self.retailerDistanceList.retailerdistanceList.count > 0){
                    self.selectedDistance = self.retailerDistanceList.retailerdistanceList[self.retailerDistanceList.retailerdistanceList.count - 1].getRetailerdistanceid()
                    self.text_Distance.text = self.retailerDistanceList.retailerdistanceList[self.retailerDistanceList.retailerdistanceList.count - 1].getDistancename()
